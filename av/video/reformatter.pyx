...
class ColorPrimaries(IntEnum):
    RESERVED0 = lib.AVCOL_PRI_RESERVED0
    BT709 = lib.AVCOL_PRI_BT709
    UNSPECIFIED = lib.AVCOL_PRI_UNSPECIFIED
    RESERVED = lib.AVCOL_PRI_RESERVED
    BT470M = lib.AVCOL_PRI_BT470M
    BT470BG = lib.AVCOL_PRI_BT470BG
    SMPTE170M = lib.AVCOL_PRI_SMPTE170M
    SMPTE240M = lib.AVCOL_PRI_SMPTE240M
    FILM = lib.AVCOL_PRI_FILM
    BT2020 = lib.AVCOL_PRI_BT2020
    SMPTE428 = lib.AVCOL_PRI_SMPTE428
    SMPTEST428_1 = lib.AVCOL_PRI_SMPTEST428_1
    SMPTE431 = lib.AVCOL_PRI_SMPTE431
    SMPTE432 = lib.AVCOL_PRI_SMPTE432
    EBU3213 = lib.AVCOL_PRI_EBU3213
    JEDEC_P22 = lib.AVCOL_PRI_JEDEC_P22
    NB = lib.AVCOL_PRI_NB


class ColorTransferCharacteristic(IntEnum):
    RESERVED0 = lib.AVCOL_TRC_RESERVED0
    BT709 = lib.AVCOL_TRC_BT709
    UNSPECIFIED = lib.AVCOL_TRC_UNSPECIFIED
    RESERVED = lib.AVCOL_TRC_RESERVED
    GAMMA22 = lib.AVCOL_TRC_GAMMA22
    GAMMA28 = lib.AVCOL_TRC_GAMMA28
    SMPTE170M = lib.AVCOL_TRC_SMPTE170M
    SMPTE240M = lib.AVCOL_TRC_SMPTE240M
    LINEAR = lib.AVCOL_TRC_LINEAR
    LOG = lib.AVCOL_TRC_LOG
    LOG_SQRT = lib.AVCOL_TRC_LOG_SQRT
    IEC61966_2_4 = lib.AVCOL_TRC_IEC61966_2_4
    BT1361_ECG = lib.AVCOL_TRC_BT1361_ECG
    IEC61966_2_1 = lib.AVCOL_TRC_IEC61966_2_1
    BT2020_10 = lib.AVCOL_TRC_BT2020_10
    BT2020_12 = lib.AVCOL_TRC_BT2020_12
    SMPTE2084 = lib.AVCOL_TRC_SMPTE2084
    SMPTEST2084 = lib.AVCOL_TRC_SMPTEST2084
    SMPTE428 = lib.AVCOL_TRC_SMPTE428
    SMPTEST428_1 = lib.AVCOL_TRC_SMPTEST428_1
    ARIB_STD_B67 = lib.AVCOL_TRC_ARIB_STD_B67
    NB = lib.AVCOL_TRC_NB
